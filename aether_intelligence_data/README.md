...
## Purpose
Directory containing aether_intelligence_data related files
...
- `current_cycle.json` - Configuration file
- `detected_contradictions.json` - Configuration file
- `learning_cycles.json` - Configuration file
- `learning_goals.json` - Configuration file
- `resolution_strategies.json` - Configuration file
