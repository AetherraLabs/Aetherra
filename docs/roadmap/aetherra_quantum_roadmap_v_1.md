...
- When this roadmap reaches COMPLETE status, keep this file in docs/roadmap and add a completion header (date, tag). Re-run docs consistency to ensure indexes and links remain valid.
