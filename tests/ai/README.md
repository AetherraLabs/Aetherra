...
## Purpose
Directory containing ai related files
...
- `test_ai_fallback.py` - Test script to demonstrate Lyrixa's Multi-AI Fallback System...
- `test_ai_status_only.py` - Test file
- `test_chat_intelligence.py` - Test file
- `test_conversation_response.py` - Test file
- `test_intelligence_core.py` - 🧠 Lyrixa Intelligence Core Test Suite
====================================

Comprehensive testing fo...
