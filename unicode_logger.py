...
def get_safe_logger(name):
    ...
    logger.safe_info = lambda msg, *args, **kwargs: safe_log(logging.INFO, msg, *args, **kwargs)
    logger.safe_error = lambda msg, *args, **kwargs: safe_log(logging.ERROR, msg, *args, **kwargs)
    logger.safe_warning = lambda msg, *args, **kwargs: safe_log(logging.WARNING, msg, *args, **kwargs)
