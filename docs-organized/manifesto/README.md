...
## Purpose
Directory containing manifesto related files
...
- `AETHERRA_MANIFESTO.md` - Documentation file
- `AI_OS_MANIFESTO.md` - Documentation file
- `SELF_ORGANIZING_INTELLIGENCE.md` - Documentation file
