...
class Trainer:
    ...
    def __init__(
        ...
        | None = None,
        eval_dataset: Union[Dataset, dict[str, Dataset], "datasets.Dataset"]
        | None = None,
    ...
    def get_optimizer_group(
        self, param: str | torch.nn.parameter.Parameter | None = None
    ):
        """
    ...
    def _load_callback_state(self):
        ...
        for stored_callback, data in self.state.stateful_callbacks.items():
            ...
            if any(
                ...
                for callback, callback_data in zip(duplicates, data, strict=False):
    ...
    def prediction_loop(
        ...
        losses_host: torch.Tensor | None = None
        preds_host: torch.Tensor | list[torch.Tensor] | None = None
        labels_host: torch.Tensor | list[torch.Tensor] | None = None
        inputs_host: torch.Tensor | list[torch.Tensor] | None = None
