        ...
        # Batched data
            ...
            if isinstance(kwargs["question"], list) and isinstance(
                ...
                inputs = [
                    ...
                    for Q, C in zip(kwargs["question"], kwargs["context"], strict=False)
                ]
    ...
    def create_sample(
        ...
        if isinstance(question, list):
            return [
                ...
                for q, c in zip(question, context, strict=False)
            ]
    ...
    def postprocess(
        ...
        for output in model_outputs:
            ...
            if not self.tokenizer.is_fast:
                ...
                for s, e, score in zip(starts, ends, scores, strict=False):
