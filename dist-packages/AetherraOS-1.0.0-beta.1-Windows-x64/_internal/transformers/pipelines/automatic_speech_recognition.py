...
class AutomaticSpeechRecognitionPipeline(ChunkPipeline):
    ...
    def _sanitize_parameters(
        ...
        if hasattr(self, "generation_config") and hasattr(
            self.generation_config, "return_timestamps"
        ):
            return_timestamps = (
                return_timestamps or self.generation_config.return_timestamps
            )
    ...
    def _forward(self, model_inputs, return_timestamps=False, **generate_kwargs):
        ...
        if self.type in {"seq2seq", "seq2seq_whisper"}:
            ...
            return_timestamps = return_timestamps or getattr(
