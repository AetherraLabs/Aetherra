...
def supported_features_mapping(
    *supported_features: str, onnx_config_cls: str | None = None
...
class FeaturesManager:
    ...
    _SUPPORTED_MODEL_TYPE = {
        ...
        "poolformer": supported_features_mapping(
            "default",
            "image-classification",
            onnx_config_cls="models.poolformer.PoolFormerOnnxConfig",
        ),
    ...
    def get_supported_features_for_model_type(
        model_type: str, model_name: str | None = None
    ) -> dict[str, Callable[[PretrainedConfig], OnnxConfig]]:
        """
    ...
    @staticmethod
    def determine_framework(model: str, framework: str | None = None) -> str:
        """
    ...
    def check_supported_model_or_raise(
        ...
        return model.config.model_type, FeaturesManager._SUPPORTED_MODEL_TYPE[
            model_type
        ][feature]
