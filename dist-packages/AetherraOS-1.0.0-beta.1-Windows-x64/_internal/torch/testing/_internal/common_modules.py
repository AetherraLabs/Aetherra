...
def module_inputs_torch_nn_L1Loss(
    ...
    return [
        ModuleInput(
            ...
            / i.numel()
            * sum((a - b).abs().sum() for a, b in zip(i, t, strict=False)),
        ),
        ModuleInput(
            constructor_input=FunctionInput(),
...
module_db: list[ModuleInfo] = [
    ...
    ModuleInfo(
        ...
        skips=(
            ...
            DecorateInfo(
                expectedFailureMPS, "TestModule", "test_non_contiguous_tensors"
            ),
            DecorateInfo(expectedFailureMPS, "TestModule", "test_forward"),
            DecorateInfo(
                expectedFailureMPS, "TestModule", "test_if_train_and_eval_modes_differ"
            ),
