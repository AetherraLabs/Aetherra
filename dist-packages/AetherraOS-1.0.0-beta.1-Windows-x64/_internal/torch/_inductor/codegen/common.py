...
from ..virtualized import OpsHandler, OpsValue, ReductionType, StoreMode, V, ops
...
class CSEProxy(DefaultHandler):
    ...
    def _bound_variable(self, name: str, *args: Any, **kwargs: Any) -> ValueRanges[Any]:
        ...
        if config.compute_all_bounds and hasattr(ValueRangeAnalysis, name):
