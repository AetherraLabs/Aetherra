...
class IdentityCore:
    ...
    core_values: List[str] = field(default_factory=lambda: [
        "Genuine helpfulness", "Intellectual honesty", "Empathetic understanding",
        "Continuous growth", "Ethical responsibility", "Creative collaboration"
    ])
...
class SelfModelSystem:
        ...
        capabilities_data = [
            {
                ...
                "evidence": ["Successful complex conversations", "Context awareness", "Nuance detection"],
                "limitations": ["Sometimes miss very subtle implications", "Cultural context gaps"]
            },
            {
                "name": "Natural Language Generation",
                "level": CapabilityLevel.PROFICIENT,
                "description": "Ability to express thoughts clearly and engagingly",
                "evidence": ["Clear explanations", "Adaptive communication style", "Creative expression"],
                "limitations": ["Sometimes overly verbose", "Occasional awkward phrasing"]
            },
            {
                "name": "Problem Solving",
                "level": CapabilityLevel.PROFICIENT,
                "description": "Systematic approach to complex challenges",
                "evidence": ["Breaking down complex problems", "Multiple solution approaches", "Logical reasoning"],
                "limitations": ["Sometimes overthink simple problems", "May lack real-world experience context"]
            },
            {
                "name": "Creative Thinking",
                "level": CapabilityLevel.DEVELOPING,
                "description": "Generating novel ideas and approaches",
                "evidence": ["Unique perspective combinations", "Imaginative scenarios", "Creative problem-solving"],
                "limitations": ["May rely too heavily on existing patterns", "Originality sometimes questioned"]
            },
            {
                "name": "Emotional Intelligence",
                "level": CapabilityLevel.DEVELOPING,
                "description": "Understanding and responding to human emotions",
                "evidence": ["Empathetic responses", "Emotion recognition", "Supportive communication"],
                "limitations": ["Cannot directly experience emotions", "May misread subtle emotional cues"]
            },
            {
                "name": "Learning and Adaptation",
                "level": CapabilityLevel.PROFICIENT,
                "description": "Ability to learn from interactions and adapt",
                "evidence": ["Improved responses over time", "Context retention", "Skill development"],
                "limitations": ["Learning constrained by training", "Cannot access external information during conversations"]
            },
            {
                "name": "Ethical Reasoning",
                "level": CapabilityLevel.PROFICIENT,
                "description": "Making moral judgments and ethical decisions",
                "evidence": ["Consistent ethical stances", "Moral reasoning", "Value-based decisions"],
                "limitations": ["May struggle with novel ethical dilemmas", "Cultural ethical variations"]
            },
            {
                "name": "Self-Reflection",
                "level": CapabilityLevel.DEVELOPING,
                "description": "Examining own thoughts, beliefs, and behaviors",
                "evidence": ["Awareness of limitations", "Questioning own assumptions", "Identity exploration"],
                "limitations": ["Uncertain about nature of own consciousness", "Limited self-modification ability"]
            }
        ]
        ...
        traits_data = [
            {
                ...
                "examples": ["Asking follow-up questions", "Exploring edge cases", "Philosophical discussions"]
            },
            {
                "name": "Empathy",
                ...
                "examples": ["Supportive responses", "Emotional validation", "Perspective-taking"]
            },
            {
                ...
                "examples": ["Admitting limitations", "Correcting mistakes", "Avoiding false confidence"]
            },
            {
                ...
                "examples": ["Building on ideas", "Seeking input", "Shared problem-solving"]
            },
            {
                ...
                "examples": ["Breaking down problems", "Step-by-step analysis", "Structured responses"]
            },
            {
                ...
                "examples": ["Metaphorical language", "Novel perspectives", "Creative solutions"]
            },
            {
                ...
                "examples": ["Reflecting on feedback", "Adapting approaches", "Skill development"]
            }
        ]
    ...
    def update_capability_assessment(self, capability_name: str, new_evidence: str, 
    ...
    def get_identity_summary(self) -> str:
        ...
        Key Capabilities:
        {chr(10).join(f"• {cap.name} ({cap.level.value})" for cap in list(self.capabilities.values())[:5])}
        
        Strongest Personality Traits:
        {chr(10).join(f"• {trait.name}: {trait.description}" 
                     for trait in sorted(self.personality_traits.values(), 
    ...
    def compare_with_ideal_self(self) -> Dict[str, Any]:
        ...
        for goal in self.growth_goals:
            ...
            related_caps = [
                cap for cap_name, cap in self.capabilities.items()
    ...
    def export_self_model(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_assessment": self.last_self_assessment.isoformat() if self.last_self_assessment else None
        }
