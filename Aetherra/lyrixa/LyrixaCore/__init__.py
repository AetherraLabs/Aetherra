...
# Import core systems
from .IdentityAgent import get_identity_agent, IdentityAgent
...
class LyrixaCoreInterface:
    ...
    def process_user_interaction(self, user_id: str, message: str, 
        ...
        ethical_guidance = []
        if any(word in message.lower() for word in ["should", "moral", "ethical", "right", "wrong"]):
        ...
        processing_result = {
            ...
            "personality_context": {
                ...
                for trait in list(self.identity_agent.self_model_system.personality_traits.values())[:3]
            },
            "relevant_beliefs": [
                belief.name for belief in list(self.identity_agent.beliefs_system.beliefs.values())[:3]
    ...
    def reflect_on_experience(self, experience: str, outcome: str, 
    ...
    def update_capability(self, capability_name: str, evidence: str, 
...
if __name__ == "__main__":
    ...
    decision = core.make_decision(
        ...
        ["Admit uncertainty and offer research", "Give confident but potentially wrong answer", "Redirect conversation"]
    )
