...
## Purpose
Directory containing migration related files
...
- `agent_deduplication_report.json` - Configuration file
- `agent_discovery_report_20250726_231705.json` - Configuration file
- `migration_plan.json` - Configuration file

#### Python Module

- `component_migrator.py` - Component Migrator
