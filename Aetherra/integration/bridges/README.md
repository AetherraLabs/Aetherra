...
- `aetherra_lyrixa_bridge.py` - Aetherra-Lyrixa Integration Bridge
Core communication layer between Aetherra and Lyrixa systems....
- `memory_adapter.py` - Memory Integration Adapter
Connects Aetherra and Lyrixa memory systems....
- `memory_adapter_impl.py` - Memory Adapter Implementation
