...
class AdvancedProjectAnalyzer:
    ...
    def analyze_markdown_file(self, filepath, content):
        ...
        analysis['code_blocks'] = [{'language': c[0], 'code': c[1][:100]} for c in code_blocks]
    ...
    def calculate_dict_depth(self, d):
        ...
        if isinstance(d, dict) and d:
            ...
            return max(self.calculate_dict_depth(item) for item in d if isinstance(item, (dict, list)))
        return 0
